          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" novalidate action = # enctype="multipart/form-data" method="POST">
                ...
                <div class="col-md-6 position-relative">
                  <label class="form-label">Contact Number (Format: 09XXXXXXXXX)<font color = "red">*</font></label>
                  <input type="number" class="form-control" id="validationTooltip01" name = "contact_num" maxlength="11" required>
                  <div class="invalid-tooltip">
  ...
  <div class="col-sm-12">
    ...
    <div class="invalid-tooltip">
      The Active field is required.
                ...
                <div class="col-12">
                  <button type="submit" class="btn btn-warning" name="submit">Update User</button>
