...
if (isset($_SESSION['user_type']) && $_SESSION['user_type'] === 'Administrator') {
    ...
    $filename = 'profilingsystem_' . date('Y-m-d_H-i-s') . '.sql';
    ...
    // Create a SQL dump of the database tables
    $output = '';
    ...
    // Output the SQL dump to the browser for download
    echo $output;
} else {
    // If the user is not logged in as an admin, display an error message
