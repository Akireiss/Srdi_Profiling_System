...
<main id="main" class="main">
    ...
    while ($row = mysqli_fetch_array($result)) {
        echo '<tr>';
        echo '<td><a href="edit_user.php?id=' . $row['municipality_id'] . '">' . $row['municipality_name'] . '</a></td>';
        echo '<td>' . $row['province_id'] . '</td>';
        echo '<td>';
        echo '<a href="view_user.php?id=' . $row['municipality_id'] . '"><i class="ri-eye-line"></i></a>';
        echo '<a href="edit_user.php?id=' . $row['municipality-id'] . '"><i class="bi bi-pencil-square"></i></a>';
        echo '</td>';
        echo '</tr>';
    }
    ?>
