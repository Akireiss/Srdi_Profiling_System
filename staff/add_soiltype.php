...
if(!isset($_SESSION['user_id'])) {
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($result!= 0) {
      ...
      $message = "Soil Type Already Exist!";
    }
  }
}
?>
            ...
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" novalidate action=# enctype="multipart/form-data" method="POST">
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <input type="text" class="form-control" id="validationTooltip01" name="soil_type" required>
                  <div class="invalid-tooltip">
                    The Soil  field is required.
                  </div>
                </div>
                ...
                <div class="col-12">
                  <button type="submit" class="btn btn-warning" name="submit">Save Soil Type</button>
