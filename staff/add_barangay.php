          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-6 position-relative">
                  <label class="form-label">Barangay Description<font color = "red">*</font></label>
                ...
                <div class="col-md-6 position-relative">
                  <label class="form-label">Barangay Code<font color = "red">*</font></label>
                  <input type="text" class="form-control" id="validationTooltip01" name = "region_code" required autofocus="autofocus">
                  <div class="invalid-tooltip">
                    The Barangay Code field is required.
                  </div>
                </div>

                <div class="col-12">
                  <button type="submit" class="btn btn-warning" name="submit">Save Barangay </button>
