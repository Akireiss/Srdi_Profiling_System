...
if(!isset($_SESSION['user_id'])) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $status   = $_POST['status'];
    $result = $db->addFarmTools($farm_tools, $status);
    if ($result != 0) {
      $message = "Farm Tool Successfully Added!";
    } else {
      $message = "Farm Tool Attainment Already Exist!";
    }
  }
}
?>
            ...
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" novalidate action=# enctype="multipart/form-data" method="POST">
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <input type="text" class="form-control" id="validationTooltip01" name="farm_tools" required>
                  <div class="invalid-tooltip">
                    The Farm Tools field is required.
                  </div>
                </div>
                ...
                <div class="col-12">
                  <button type="submit" class="btn btn-warning" name="submit">Save Farm Tools</button>
