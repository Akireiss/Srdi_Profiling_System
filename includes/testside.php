...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed"  href="ct.php">

      <i class="bi bi-people" style="color: white;"></i><span>Cocoon Producers</span></i>
    </a>
  </li>
...
<!--Project Site-->
  ...
  <li class="nav-item">
    ...
    <li class="nav-item">
      ...
      <p class="text-white mx-3 ml-3 mt-2 fw-bold">Location</p>
      ...
      <li>
        ...
        <li>
          <a href="municipality.php">
            <i class="bi bi-circle" ></i><span>Municipality</span>
          </a>
        </li>
        <li>
          <a href="barangay.php">
        ...
        <p class="text-white mx-3 ml-3 mt-2 fw-bold">Components</p>
      <li>
          <a href="agency.php">
        ...
        <li>
          <a href="topography.php">
            <i class="bi bi-circle" ></i><span>Topography</span>
          </a>
        </li>
        <li>
          <a href="source_of_income.php">
            <i class="bi bi-circle" ></i><span>Source of Income</span>
          </a>
        </li>
        <li>
          <a href="farm_tools.php">
            <i class="bi bi-circle" ></i><span>Farm Tools</span>
          </a>
        </li>
        <li>
          <a href="land_type.php">
            <i class="bi bi-circle" ></i><span>Land Type</span>
          </a>
        </li>
        <li>
          <a href="tenancy.php">
            <i class="bi bi-circle" ></i><span>Tenancy Status</span>
          </a>
        </li>
        <li>
          <a href="irrigation.php">
            <i class="bi bi-circle" ></i><span>Souce of Irrigation</span>
          </a>
        </li>
        <li>
          <a href="soil_type.php">
            <i class="bi bi-circle" ></i><span>Soil Type</span>
          </a>
        </li>
  ...
  <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
        <i class="bi bi-person-workspace" style="color: white;"></i><span>System</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
      <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
          <a href="backup_button.php">
        ...
        <li>
          <a href="monitoring_team.php">
            <i class="bi bi-circle" ></i><span>Upload Database</span>
          </a>
        </li>
    ...
    <!-- End Settings Nav -->
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#charts-side" data-bs-toggle="collapse" href="#">
        <i class="bi bi-person-workspace" style="color: white;"></i><span>User Settings</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
      <ul id="charts-side" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="report.php">
      <i class="bx bxs-report" style="color: white;"></i><span>Reports</span>
    </a>
