...
>>>>>>> c006b2e43b9881f81e003c0f907633633ca59847
}
?>
                  ...
                  <form class="row g-3 needs-validation" novalidate action="#" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row g-3  needs-validation md:w-full" novalidate>
                      <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="validationTooltip01" name="age" value="<?php echo $age; ?>">
                        <div class="valid-feedback">
                          Looks good!
                        </div>
                      </div>
...
<<<<<<< HEAD
                      ...
                      <div class="col-md-3 position-relative">
                        ...
                        <div class="col-sm-12">
                          <select class="form-select" aria-label="Default select example" name="municipality" id="municipality" value="<?php echo $citymunCode; ?>">
                      ...
                      <div class="row g-3  needs-validation md:w-full" novalidate>
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="validationTooltip01" name="civil_status" value="<?php echo $civil_status; ?>">
                          <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="validationTooltip01" name="name_spouse" value="<?php echo $name_spouse; ?>">
                          <div class="invalid-feedback">
                        ...
                        <div class="col-md-3 mt-1">
                          ...
                          <input type="text" class="form-control" id="validationTooltip01" name="farm_participate" value="<?php echo $farm_participate; ?>">
                          <div class="invalid-feedback">
                            Please provide a name of spouse.
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mt-1">
                          ...
                          <input type="text" class="form-control" id="validationTooltip01" name="cannot_participate" value="<?php echo $cannot_participate; ?>">
                          <div class="invalid-feedback">
                            Please provide a name of spouse.
                          </div>
                        </div>
                        <div class="col-md-3 mt-1">
                          ...
                          <input type="text" class="form-control" id="validationTooltip01" name="male" value="<?php echo $male; ?>">
                          <div class="invalid-feedback">
                            Please provide a name of spouse.
                          </div>
                        </div>
                        <div class="col-md-3 mt-1">
                          ...
                          <input type="text" class="form-control" id="validationTooltip01" name="female" value="<?php echo $female; ?>">
                          <div class="invalid-feedback">
                            Please provide a name of spouse.
                          </div>
                        </div>
...
<<<<<<< HEAD
                        ...
                        <div class="col-md-6 ">
                          ...
                          <input type="text" class="form-control" id="validationTooltip01" name="years_in_farming" value="<?php echo $years_in_farming; ?>">
                          <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 ">
                          ...
                          <input type="text" class="form-control" id="validationTooltip01" name="available_workers" value="<?php echo $available_workers; ?>">
                          <div class="invalid-feedback">
...
<<<<<<< HEAD
                      ...
                      <!-- Inside your PHP loop for displaying images/PDFs --><!-- ID Picture -->
                      <div class="col-md-6 mb-4">
                        <div class="file-container">
                          <a href="view_image.php?image=<?= $id_pic ?>" target="_blank" rel="noopener noreferrer">
                            <img src="<?= $id_pic ?>" alt="ID Picture" class="img-fluid w-25">
                          </a>
                          <i class="bi bi-x-lg text-danger mx-2 remove-file" data-type="image" data-file-id="<?= $cocoonID ?>"></i>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 mb-4">
                        <div class="file-container">
                          <a href="<?= $intent ?>" target="_blank" rel="noopener noreferrer">View PDF</a>
                          <i class="bi bi-x-lg text-danger mx-2 remove-file" data-type="pdf" data-file-id="<?= $cocoonID ?>"></i>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="file-container">
                          <a href="view_image.php?image=<?= $bypic ?>" target="_blank" rel="noopener noreferrer">
                            <img src="<?= $bypic ?>" alt="2x2 Picture" class="img-fluid w-25">
                          </a>
                          <i class="bi bi-x-lg text-danger mx-2 remove-file" data-type="bypic" data-file-id="<?= $cocoonID ?>"></i>
                        </div>
                      </div>

                      <!-- Signature of Farmer Cooperator -->
                      <div class="col-md-6">
                        <div class="file-container">
                          <a href="view_image.php?image=<?= $signature ?>" target="_blank" rel="noopener noreferrer">
                            <img src="<?= $signature ?>" alt="Signature" class="img-fluid w-25">
                          </a>
                          <i class="bi bi-x-lg text-danger mx-2 remove-file" data-type="signature" data-file-id="<?= $cocoonID ?>"></i>
                        </div>
                      </div>
