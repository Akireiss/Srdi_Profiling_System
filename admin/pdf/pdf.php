...
<body>
        ...
        <table width="100%" style="margin-bottom: 5px">
            <tbody>
                <tr>
                    ...
                    <td>Date of Validation: <span class="underline">
                            <?php echo $date_validation ?>
                        </span></td>
                </tr>
                <tr>
    ...
    <tbody>
        ...
        <table>
            <tr>
                <td width="80%">Permanent Address: <span class="underline">
                        <?php echo $barangayName ?>,
                        <?php echo $citymunName ?>,
                        <?php echo $provName ?>
                    </span></td>
            </tr>
            </tbody>
        ...
        <table width="100%">
            <tbody>
                <tr>
                    <td width="5%"></td>
                    <td width="50%">Educational Attainment:<span class="underline">
                            <?php echo $educationName ?>
                        </span></td>
                    <td width="25%">Religion: <span class="underline">
        ...
        <table width="100%">
            <tbody>
                <tr>
                    <td width="6%"></td>
                    <td width="50%">Civil Status:<span class="underline">
                            <?php echo $civilName ?>
                        </span></td>
                    <td width="50%">If married, name of spouse:<span class="underline">
                            <?php echo $name_spouse ?>
                        </span></td>
                </tr>
        ...
        <table width="100%">
            <tbody>
                <tr>
                    <td widt="10%"></td>
                    <td width="50%"><span class="underline">
                            <?php echo $farm_participate; ?>
                        </span>can participate in farm work
                    </td>
                    <td width="40%"><span class="underline">
                            <?php echo $cannot_participate; ?>
                        </span>cannot do farm work</td>
                </tr>
        ...
        <table width="100%">
            <tbody>
                <tr>
                    <td></td>
                    <td width="20%"><span class="underline">
                            <?php echo $male; ?>
                        </span>male</td>
                    <td width="70%"><span class="underline">
                            <?php echo $female; ?>
                        </span>female</td>
                </tr>
        ...
        <table width="75%">
            <tbody>
                <tr style="margin-bottom: 5px">
                    ...
                    <td></td>
                    <td>Number of years in farming:<span class="underline">
                            <?php echo $years_in_farming; ?>
                        </span></td>

                </tr>
                <tr style="margin-bottom: 5px">
                    <td width="10%"></td>
                    <td>Number of available workers:<span class="underline">
                            <?php echo $available_workers; ?>
                        </span></td>
                </tr>
                <tr style="margin-bottom: 5px">
                    <td width="10%"></td>
...
?>
 ...
 <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path($id_pic))) }}"> -->
