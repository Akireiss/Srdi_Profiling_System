...
if (isset($message)) {
  ...
  <section class="section">
    ...
    <input type="number" class="form-control" id="validationCustom01" step="0.01" name="area_ha">
...
<div class="col-md-2 mb-3">
    ...
    <input type="number" class="form-control" id="validationCustom02" step="0.01" name="crops_grown">
    <div class="valid-feedback">
        Looks good!
    </div>
</div>
